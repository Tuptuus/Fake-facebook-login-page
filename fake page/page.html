        ...
        <div id="lang">
            ...
            <div class = "footerLi">
                <ul id="FooterList2">
                    ...
                    <li class="List2">
                        <p title="Kupuj i sprzedawaj, korzystając z Mareketplace Facebooka" class="List3">Marketplace</p>
                    </li>
                    <li class="List2">
            ...
            <div class = "FooterLi">
                <ul id="FooterList3">
                    ...
                    <li class="List2">
                        <p title="Sprawdź Centrum informacji o głosowaniu" class="List3">Centrum informacji o głosowaniu</p>
                    </li>
                    <li class="List2">
                        <p title="Przeczytaj nasz blog, odkryj centrum zasobów i znajdź pracę" class="List3">O Facebooku</p>
                    </li>
                    <li class="List2">
            ...
            <div class="FooterLi">
                <ul id="FooterList4">
                    ...
                    <li class="List2">
                        <p title="Dowiedz się więcej o opcjach wyświetlania reklamy" class="List3">Opcje wyświetlania reklam</p>
                    </li>
                    <li class="List2">
